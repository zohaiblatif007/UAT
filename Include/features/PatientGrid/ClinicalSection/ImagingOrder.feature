...
Background: 
  ...
  Given I search <Patient> using global search
    ...
    *   I click on imaging order Update button
    ...
    |AZMAAT, Jackson|Radiology Center New Jersey|Client, Tim |02012021 21:38| Patient |       HPC       |Outside state ambulance serv::A0021|02012021 21:38|(Cholera due to Vibrio cholerae 01, biovar cholerae)|Abnormal hematopoietic cell (cell)|Imaging Order|
...
#		And I should see the newly added imaging order record <Imaging_Center> and <Date> on grid
    ...
    Examples:
    |    Patient   |      Imaging_Center     |Order_Provider|      Date    |Bill_Type|Imaging_Test_Type|        Imaging_Test           |Effective_Date|      Diagnoses       |                  Body_Site              |      Comments    |
    |AZMAAT, Jackson|Fairfax Radiology Centers|Client, Tim|02012021 21:38| Patient |      LOINC      |Amdinocillin Islt KB::1-Sep    |02012021 21:38|(Cholera, unspecified)|Bone structure of tarsus (body structure)|Edit Imaging Order|
...
#	  And I should see the deleted imaging order not present on grid
    ...
    |AZMAAT, Jackson|Fairfax Radiology Centers|
    #
