...
Background: 
  ...
  Given I search <Patient> using global search
   ...
   |  AZMAAT, Jackson|Quest Diagnostics|  Client, Tim |01/28/2021 13:57|Lipid Panel|Yes |  A00.0  |01/28/2021 13:57|Serum|     10    |Lab order added|
...
#		And I should see the newly added <Laboratary> and <Panel> lab order on grid
   ...
   |AZMAAT, Jackson|Whitehouse Analytical Lab|01/28/2021 13:57|Electrolyte Panel|Yes |  A00.9  |01/28/2021 13:57|Plasma|     10    |Lab order edit |
...
#	  And I should see the deleted lab order not present on grid
    ...
    Examples:    
   |    Patient    |         Laboratary      | 
   |AZMAAT, Jackson|Whitehouse Analytical Lab|
   #
   #
